...
<%If Action="aduserlist" Or Action="aduseradd" Or Action="adusermodify" Or Action="lowlist" Or Action="lowdaytj" Or Action="orderlist" Or Action="orderdaytj" Or Action="orderdaytjgoodstime" Or Action="aduserenoughlist" Or Action="aduserenoughadd" Or Action="imglist" Then%>
...
<%If Action="clienttj" Or Action="showlist" Or Action="iplist" Or Action="invalidiplist" Or Action="searchkeywordtj" Or Action="clickflaglist" Or Action="clickflagdetail" Or Action="daytj" Or Action="hourtj" Or Action="userdatadaytj" Or Action="daytjdetail" Or Action="lylist" Or Action="othertj" Or Action="lowuniondaytjbyusername" Or Action="lowuniondaytjbyuserid" Or Action="inputdata" Or Action="inputdataconfirm" Or Action="inputdatasave" Then%>
<ul class="tab">
...
<%If Action="sysmodify" Or Action="ipblacklist" Or Action="ipblacklistadd" Or Action="ipblacklistmoreadd" Or Action="ipblacklistmodify" Or Action="sysrecset" Or Action="agentadmodify" Or Action="setbclasslist" Or Action="setbclassadd" Or Action="setbclassmodify" Or Action="setsclasslist" Or Action="setsclassadd" Or Action="setsclassmodify" Or Action="setcontentlist" Or Action="setcontentadd" Or Action="setcontentmodify" Or Action="siteclasslist" Or Action="siteclassadd" Or Action="siteclassmodify" Or Action="adsizelist" Or Action="adsizeadd" Or Action="adsizemodify" Or Action="emailserverset" Or Action="testset" Then%>
...
<%If Action="infolist" Or Action="infoadd" Or Action="infomodify" Or Action="infoclasslist" Or Action="infoclassadd" Or Action="infoclassmodify" Then%>
...
<li><a href="?Action=infoclasslist"<%If Action="infoclasslist" Or Action="infoclassadd" Or Action="infoclassmodify" Then Response.write " class='selected'"%>><span>公告和帮助分类</span></a></li></ul>
