...
ElseIf Action="spendlist" Or Action="spendadd" Or Action="spareout" Then
 MenuCss = "main_menu8"
 MenuName = "佣金结算"
ElseIf Action="pwdmodify" Or Action="pwdanswermodify" Or Action="userpaymodify" Or Action="datamodify" Or Action="bindusermodify" Then
 MenuCss = "main_menu9"
 MenuName = "安全中心"
 ...
 <div id="head">
  <div class="box">
   ...
   <ul class="nav">	
    ...
    <li><a href="?Action=datamodify">您好，<%=SeUserName%></a></li>
    <li><A href="?Action=seuserlogout">退出</A></li>
   </ul>
  </div>
 </div>
</div>
