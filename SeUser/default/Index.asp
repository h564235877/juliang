...
Else
 SeUserName=Session("CFWztgSeUser")
End If
%>
<%
RootPath = HttpPath(2)
...
MenuAllAction2 = "|-|lowview=名下网站主"
MenuAllAction3 = "|-|daytj=每天统计|-|daytjdetail=每天详细统计"
MenuAllAction4 = "|-|spendlist=佣金结算列表|-|spendadd=佣金结算新增|-|spareout=佣金转广告主"
MenuAllAction5 = "|-|pwdmodify=修改密码|-|pwdanswermodify=修改密码保护|-|userpaymodify=修改汇款方式|-|datamodify=修改资料|-|bindusermodify=广告主绑定修改"
...
<title>客服后台_<%=SysTitle%></title>
<link rel="icon" href="../../images/favicon.ico" type="image/ico">
<meta name="keywords" content="客服后台_<%=SysTitle%>">
<meta name="description" content="客服后台_<%=SysTitle%>">
      ...
      <div class="lyear-layout-sidebar-scroll"> 
        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item<%If Instr(MenuAllAction2,"|-|" & Action & "=")>0 Then Response.write " active"%>"> <a href="?Action=lowview"><i class="mdi mdi-account"></i> 名下网站主</a> </li>
...
%>
            ...
            <li class="nav-item nav-item-has-subnav<%If Instr(MenuAllAction5,"|-|" & Action & "=")>0 Then Response.write " active open"%>">
              ...
              <ul class="nav nav-subnav">
                ...
                <li<%If Action="bindusermodify" Then Response.write " class='active'"%>> <a href="?Action=bindusermodify">修改关联商务</a> </li>
              </ul>
            </li>
...
%>
          ...
          <ul class="topbar-right">
            <li class="dropdown dropdown-profile">
              <a href="javascript:void(0)" data-toggle="dropdown">
                <img class="img-avatar img-avatar-48 m-r-10" src="images/users/avatar.jpg" alt="<%=SeUserName%>" />
                <span><%=SeUserName%> <span class="caret"></span></span>
              </a>
              <ul class="dropdown-menu dropdown-menu-right">
                ...
                <li class="divider"></li>
                <li> <a href="?Action=seuserlogout"><i class="mdi mdi-logout-variant"></i>退出登录</a> </li>
              </ul>
            </li>
            <!--切换主题配色-->
    ...
    <main class="lyear-layout-content">
     ...
     <!--#Include File="SeUser_Select.asp"-->
...
<%
Sql="Select top 7 a.AddDate,Sum(a.SeUser_Income_Cent) As SeUser_Income_Cent From CFWztg_AD_Counter_Day a inner join CFWztg_User b on a.username=b.username Where b.upusername='"&SeUserName&"'  Group By a.AddDate Order By a.AddDate Desc"
Set Rs2=Conn.Execute(Sql)
While Not Rs2.Eof
 ChartDate = ChartDate & "'" & Rs2("AddDate") & "',"
 ChartData = ChartData & FormatNumber(Cdbl(Rs2("SeUser_Income_Cent")),2,-1,0,0) & ","
Rs2.MoveNext
Wend
...
Sql="Select top 15 a.AddDate,Sum(a.Display_Counter) As Display_Counter From CFWztg_AD_Counter_Day a inner join CFWztg_User b on a.username=b.username Where b.upusername='"&SeUserName&"'  Group By a.AddDate Order By a.AddDate Desc"
Set Rs2=Conn.Execute(Sql)
While Not Rs2.Eof
