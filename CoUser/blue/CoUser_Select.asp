...
%>
<%If Action="main" Then%>
<!--#include file="../../Action/CoUser_Blue/main.asp"-->
<%End If%>

<%If Action="lowview" Then%>
<!--#include file="../../Action/CoUser/lowview.asp"-->
<%end if%>

<%If Action="daytj" Then%>
<!--#include file="../../Action/CoUser/daytj.asp"-->
<%end if%>

<%If Action="daytjdetail" Then%>
<!--#include file="../../Action/CoUser/daytjdetail.asp"-->
<%end if%>

<%If Action="spendlist" Then%>
<!--#include file="../../Action/CoUser/spendlist.asp"-->
<%End If%>

<%If Action="spendadd" Then%>
<!--#include file="../../Action/CoUser/spendadd.asp"-->
<%End If%> 
...
<!--#include file="../../Action/CoUser/pwdmodify.asp"-->
<%End if%>

<%If Action="pwdanswermodify" Then%>
<!--#include file="../../Action/CoUser/pwdanswermodify.asp"-->
<%End if%>
		
<%If Action="userpaymodify" then%>
<!--#include file="../../Action/CoUser/userpaymodify.asp"-->
<%End If%>

<%If Action="datamodify" Then%>
<!--#include file="../../Action/CoUser/datamodify.asp"-->
<%End If%>

<%If Action="sysinfolist" Then%>
<!--#include file="../../Action/CoUser/sysinfolist.asp"-->
<%End If%>

<%If Action="sysinfoshow" Then%>
 <!--#include file="../../Action/CoUser/sysinfoshow.asp"-->
<%End If%>
	
<%If Action="gbooklist" Then%> 
 <!--#include file="../../Action/CoUser/gbooklist.asp"-->
<%End IF%>

<%If Action="gbookadd" Then%> 
 <!--#include file="../../Action/CoUser/gbookadd.asp"-->
<%End IF%>
