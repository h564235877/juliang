...
<form name="form3" method="post" action="../../CoUser.aspx?Action=pwdanswermodifysave">
...
　 <a href="../../CoUser.aspx?Action=pwdanswersend" target="_blank"><font color="#0000FF">发到我的Email修改</font></a> (注：如果忘记原密码回答答案可发送到自己的Email内修改)</td>
</tr>
</table>
</form>