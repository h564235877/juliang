...
<form name="form3" method="post" action="../../SeUser.aspx?Action=pwdmodifysave">
...
<tr>
<td width="100" class="td_r">原密码：</td>
<td>
...
<td>
<div align="center">
<a href="<%=RsSet("LoginUrl")%>" target="_blank" class="btn btn-primary">请到主站登陆后修改密码</a>
</div></td>
</tr>
</table>
<%End If%>