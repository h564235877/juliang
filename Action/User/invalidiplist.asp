...
<%
Sql="Select AddDate From CFWztg_Invalid_Ip Where UserName='"&UserName&"' Group By AddDate Order By AddDate Desc"
...
Sql="Select Count(1) From CFWztg_Invalid_Ip where UserName='"&UserName&"' And Datediff(d,AddDate,'"&AddDate&"')=0 And ClickFlag<>15 And ClickFlag<>16 And ClickFlag<>39 And ClickFlag<>40"&SqlW
Set Rs=Conn.execute(Sql)
IpTotal=Rs(0)
Rs.Close


Sql="Select Top 2000 *,datediff(s,firstshowtime,addtime) SpaceTime From CFWztg_Invalid_Ip WITH(NOLOCK) where UserName='"&UserName&"' And Datediff(d,AddDate,'"&AddDate&"')=0 And ClickFlag<>15 And ClickFlag<>16 And ClickFlag<>39 And ClickFlag<>40"&SqlW
