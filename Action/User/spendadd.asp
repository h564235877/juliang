...
<form name="form4" method="post" action="../../User.aspx?Action=spendsave&RefUrl=<%=Server.URLEncode(Request.ServerVariables("Http_Referer"))%>">
<table class="tb_1">
<tr class="tr_1"> 
    ...
    <tr> 
      ...
      <td><%
Response.write Int(Cdbl(rs("Spare_Cent"))*100)/100&"元"'--FormatNumber会四舍五入,小数点第三位不要四舍五入,不然可能提交大于余额的数无法结算
%></td>
    </tr>
    <tr> 
...
<%
Response.write "(每次最低需结算" & RsSet("LowSpendCent") & "元"
...
<%If Not(Rs("pay_type")="alipay" Or Rs("pay_type")="tenpay") Then%>
<tr> 
