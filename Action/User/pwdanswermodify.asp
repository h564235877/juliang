...
<form name="form3" method="post" action="../../User.aspx?Action=pwdanswermodifysave">
<table class="tb_1">
<tr class="tr_1"> 
...
(注：如果忘记原密码回答答案可发送到自己的Email内修改,<a href="../../User.aspx?Action=pwdanswersend"><font color="#0000FF">发送到Email修改</font></a>)</td>
</tr>
</table>
</form>