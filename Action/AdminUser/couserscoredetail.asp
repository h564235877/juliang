...
If CoUserName="" Or IsDate(AddDate) = False Then Call AlertBack("缺少参数!",1)
...
Sql=Sql&"group by b.adusername,a.ad_id) c  inner join CFWztg_User d on c.adusername=d.username and d.upusername='"&CoUserName&"'  group by c.adusername,c.ad_id order by CoUser_Income_Cent desc"&chr(10)
...
%>
<table class="tb_2">
<td><span class="title">商务 <%=CoUserName%> 在 <%=AddDate%> 业绩统计</span></td>
</table>
