...
<form name="form4" method="post" action="../../AdminUser.aspx?Action=siteclassaddsave&RefUrl=<%=Server.URLEncode(Request.ServerVariables("Http_Referer"))%>">
<table class="tb_1">
<tr class="tr_1"> 
...
<td><input name="SiteClassName" type="text" id="SiteClassName"></td>
</tr>
<tr> 
<td></td>
