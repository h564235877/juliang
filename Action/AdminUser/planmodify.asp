...
Sql="Select AdUserName,PlanName,PlanState From CFWztg_Plan where ID="&Plan_ID
Rs.open Sql,Conn,1,1
AdUserName=Rs("AdUserName")
PlanName=Rs("PlanName")
PlanState=Rs("PlanState")
Rs.Close
%>
...
<form method="post" action="../../AdminUser.aspx?Action=planmodifysave&Plan_ID=<%=Plan_ID%>&AdUserName=<%=AdUserName%>&RefUrl=<%=Server.URLEncode(Request.ServerVariables("Http_Referer"))%>" name=form_planmodify id=form_planmodify>
