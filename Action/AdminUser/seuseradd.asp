...
<form name="form2" method="post" action="../../AdminUser.aspx?Action=seuseraddsave&ID=<%=ID%>&RefUrl=<%=Server.URLEncode(Request.ServerVariables("Http_Referer"))%>">
<table class="tb_1">
<tr class="tr_1"> 
<td colspan="2">客服新增</td>
</tr>
<tr>
<td width="100" class="td_r">客服用户名：</td>
<td><input name="username" type="text" id="username">*(必须为小写字母、数字或下划线)</td>
</tr>
<tr>
<td class="td_r">客服密码：</td>
<td><input name="pwd" type="password" id="pwd" STYLE="ime-mode:inactive;">*</td>
</tr>
<tr>
<td class="td_r">客服呢称：</td>
<td><input name="usernick" type="text" id="usernick" value=""></td>
</tr>
<tr>
<td class="td_r">客服QQ：</td>
