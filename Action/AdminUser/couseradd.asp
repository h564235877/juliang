...
<form name="form2" method="post" action="../../AdminUser.aspx?Action=couseraddsave&ID=<%=ID%>&RefUrl=<%=Server.URLEncode(Request.ServerVariables("Http_Referer"))%>">
<table class="tb_1"><tr class="tr_1"> 
<td colspan="2">商务新增</td>
</tr>
<tr>
<td width="120" class="td_r">商务用户名：</td>
