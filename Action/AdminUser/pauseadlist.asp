...
Sql="Select a.*,b.PlanState From CFWztg_AD a inner join CFWztg_Plan b on a.Plan_ID=b.ID where a.AdState=5 or a.AdState=6 or b.PlanState=3"
...
%>
<a href="javascript:;" onclick="$(function () { confirm('确定要重新投放此广告吗?', '', function (isConfirm) {if (isConfirm) {gotoUrl('../../AdminUser.aspx?Action=adrun&ID=<%=Rs("ID")%>')}}, {confirmButtonText: '确定', cancelButtonText: '取消', width: 400});});" class="btn_add"><i class="mdi mdi-play"></i>投放</a>
<%End If%>
