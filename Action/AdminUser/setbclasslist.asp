...
$("#search").click(function(){
 var searchurl ="?Action=setcontentmodify"
 searchurl += '&SetFlag=' + $('#SetFlag').val();
...
<td>
<a href="?Action=setbclassadd" class="actionBtn add"><i class="mdi mdi-plus"></i><span>一级设置配置增加</span></a>
</td>
</tr>
</table>
<%
Sql="Select * From CFWztg_SetBClass Order By SetTaxis"
...
<td class="td_3">	  
<%
Response.write "<a href='?Action=setbclassmodify&ID="&Rs("id")&"' class=""btn_edit""><i class=""mdi mdi-pencil""></i>修改</a>"
Response.write "&nbsp;&nbsp;<a href='javascript:;' onclick=""$(function () { confirm('你确定要更新吗?', '', function (isConfirm) {if (isConfirm) {gotoUrl('../../AdminUser.aspx?Action=setbclassrenew&SetBClassFlag="&Rs("SetBClassFlag")&"')}}, {confirmButtonText: '确定', cancelButtonText: '取消', width: 400});});""class=""btn_add""><i class=""fa fa-repeat""></i>更新配置</a>"
If Rs("SetType")=2 Then
 Response.write "&nbsp;&nbsp;<a href=""javascript:;"" onclick=""$(function () { confirm('你确定要删除吗?', '', function (isConfirm) {if (isConfirm) {gotoUrl('../../AdminUser.aspx?Action=setbclassdel&SetBClassFlag="&Rs("SetBclassFlag")&"')}}, {confirmButtonText: '确定', cancelButtonText: '取消', width: 400});});"" class=""btn_del""><i class=""mdi mdi-window-close""></i>删除</a>"
End If
Response.write "&nbsp;&nbsp;<a href='?Action=setsclasslist&SetBclassFlag="&Rs("SetBclassFlag")&"' class=""btn_add""><i class=""fa fa-sign-out""></i>管理</a>"
%>
</td>
</tr>
<%
