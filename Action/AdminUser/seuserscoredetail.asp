...
If SeUserName="" Or IsDate(AddDate) = False Then Call AlertBack("缺少参数!",1)
...
Sql=Sql&"where a.adddate ='"&adddate&"' and b.upusername='"&SeUserName&"'"&chr(10)
...
<table class="tb_2">
<td><span class="title">客服 <%=SeUserName%> 在 <%=AddDate%> 业绩统计</span>
