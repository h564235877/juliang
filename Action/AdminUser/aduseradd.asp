...
<form name="form2" method="post" action="../../AdminUser.aspx?Action=aduseraddsave&ID=<%=ID%>&RefUrl=<%=Server.URLEncode(Request.ServerVariables("Http_Referer"))%>">
<table class="tb_1"><tr class="tr_1"> 
<td colspan="2">广告主新增</td>
</tr>
<tr>
