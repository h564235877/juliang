...
<table class="tb_2">
<tr>
<td><span class="title">广告所属计划投放完成状态的所有广告</span></td>
</tr>
</table>
...
Sql="Select a.* From CFWztg_AD a inner join CFWztg_Plan b on a.Plan_ID=b.ID And a.AdUserName='"&AdUserName&"' where a.AdState=4 or b.PlanState=4"
...
<a href="javascript:;" onclick="$(function () { confirm('你确定要删除吗?', '', function (isConfirm) {if (isConfirm) {gotoUrl('../../AdUser.aspx?Action=addel&ID=<%=Rs("ID")%>')}}, {confirmButtonText: '确定', cancelButtonText: '取消', width: 400});});" class="btn_del"><i class="mdi mdi-window-close"></i> 删除</a>
