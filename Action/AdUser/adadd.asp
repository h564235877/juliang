...
<form method="post" action="../../AdUser.aspx?Action=adaddsave" name=form_adadd id=form_adadd>
...
Rs2.Close
Else
 Response.write "没有可以选择的广告计划，请先<a href='?Action=planadd'>新建广告计划</a>"
End If
%>
</TD>
</TR>
...
<tr id="t_ad_class">
<td width="200" class="td_r">你想发布哪种类型广告：</td>
<td>
...
<TR id="t_uploadfiles"> 
<TD class="td_r"></TD>
<TD>图片上传：<iframe style="top:2px" ID="UploadFiles" src="../../include/upfile.asp?UserType=aduser&Site=adadd" frameborder=0 scrolling=no width="350" height="30" allowtransparency="true"></iframe></TD>
</TR>
...
<TD><input type="radio" name="sitetypeset" id="sitetypeset_0" value="0"  />不限<br>
<input type="radio" name="sitetypeset" id="sitetypeset_1" value="1" />指定终端(包含微信)<br>
<input type="radio" name="sitetypeset" id="sitetypeset_2" value="2" />只投微信<br>
