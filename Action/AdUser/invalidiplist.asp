...
<%
Sql="Select AddDate From CFWztg_Invalid_Ip Where AdUserName='"&AdUserName&"' Group By AddDate Order By AddDate Desc"
...
%>
      ...
      <td>&nbsp;</td>
      <td><input type="submit" name="search" value="查询" class="btn btn-sm btn-primary" id="search"></td>
    </tr>
</table>
...
PageUrl = "?Action="&Action&"&Ad_ID="&Ad_ID&"&AddDate="&AddDate&"&ClickFlag="&ClickFlag&"&Ip="&Ip&"&Ly="&Ly&"&SlefPageSize="&SlefPageSize

Call PxFilter(Px,"spacetime,Ip,ClickFlag,Ad_ID,Ly,Ly_2,Keyword,AddTime,AgentStr,Alexa,WebWidth,WebHeight,WebTop,WebLeft,MouseTop,MouseLeft,ScreenWidth,ScreenHeight,ScreenColorDepth,HisLen,WinOri,Hwc,Vendor,Renderer,Cct,Ostype,BrowserType,FirstShowTime,VisitTotal,ClickTotal,LowUnionUserName")
...
Sql="Select Count(1) From CFWztg_Invalid_Ip where AdUserName='"&AdUserName&"' And Datediff(d,AddDate,'"&AddDate&"')=0 And ClickFlag<>15 And ClickFlag<>16 And ClickFlag<>39 And ClickFlag<>40"&SqlW
Set Rs=Conn.execute(Sql)
IpTotal=Rs(0)


Sql="Select Top 2000 *,datediff(s,firstshowtime,addtime) SpaceTime From CFWztg_Invalid_Ip WITH(NOLOCK) where AdUserName='"&AdUserName&"' And Datediff(d,AddDate,'"&AddDate&"')=0 And ClickFlag<>15 And ClickFlag<>16 And ClickFlag<>39 And ClickFlag<>40"&SqlW
