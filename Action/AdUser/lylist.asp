...
<%
Sql="Select a.AddDate From CFWztg_Visit_Ly a inner join cfwztg_ad b on a.ad_id=b.id Where b.AdUserName='"&AdUserName&"' Group By a.AddDate Order By a.AddDate Desc"
...
<%
Sql="Select min(b.AdName) as AdName,a.Ad_ID From CFWztg_AD_Counter_Day a inner join cfwztg_ad b on a.ad_id=b.id Where b.AdUsername='"&AdUsername&"' and a.pv_counter>0 Group By a.Ad_ID Order By a.Ad_ID"
Set Rs = Server.CreateObject("Adodb.Recordset")
Rs.open Sql,Conn,1,1
While Not Rs.Eof
...
<table class="tb_1">
 ...
 Sql=Sql&" And b.AdUserName='"&AdUserName&"'"
...
End If
 ...
 Sql=Sql&" Group By AdUserName,Ad_ID,LyHead Order By a."&Px&" Desc"
