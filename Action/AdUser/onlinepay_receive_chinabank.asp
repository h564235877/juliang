...
'****************************************	' MD5密钥要跟订单提交页相同，如Send.asp里的 key = "test" ,修改""号内 test 为您的密钥
	...
	key = RsSet("Pay_ChinabankKey")								' 登陆后在上面的导航栏里可能找到“B2C”，在二级导航栏里有“MD5密钥设置”
											' 建议您设置一个16位以上的密钥或更高，密钥最多64位，但设置16位已经足够了
If key="" Or key="请实际填写或留空" Then
 Response.write "密钥参数错误"
 Response.End
End If
'****************************************
...
' 取得返回参数值
	...
	OrderCode = ChkStr(v_oid,1)'取得发给支付系统的自己定义的订单号
