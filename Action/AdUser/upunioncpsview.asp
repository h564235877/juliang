...
<form action="?Action=upunioncpsin" method="post" name="form2" target="_blank">
<table class="tb_1"><tr class="tr_1"> 
      <td colspan="2">CPS收入导入</td>
    </tr>
    <tr>
	...
	<tr>
      <td class="td_r">上级联盟广告主名：</td>
      <td><input name="AdUserName" type="text" id="AdUserName">(注：可留言空则导入所有广告主的cps数据,填写则导入单个广告主)</td>
    </tr>
	<tr>
	<tr>
      <td class="td_r">CPS获利的百分比：</td>
      <td><input name="TcRate" type="text" id="TcRate">%(注：在已经获利里给下线联盟的比率)</td>
    </tr>
	<tr>
