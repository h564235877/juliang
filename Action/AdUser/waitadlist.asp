...
<table class="tb_2">
<tr>
<td><span class="title">等待通过审核的广告</span></td>
</tr>
</table>
...
Sql="Select * From CFWztg_AD where AdState=1 And AdUserName='"&AdUserName&"' Order By ID Desc"
...
<a href="javascript:;" onclick="$(function () { confirm('确定要删除选择的这些广告吗?', '', function (isConfirm) {if (isConfirm) {$('#form_adlist').attr('action','../../AdUser.aspx?Action=adseldel');$('#form_adlist').submit();}}, {confirmButtonText: '确定', cancelButtonText: '取消', width: 400});});" class="btn btn-xs btn-danger"><i class="mdi mdi-window-close"></i>删除选择</a>
